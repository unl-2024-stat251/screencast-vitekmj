...
I will use ggplot 2 to show correlations. I will use dplyr to filter and manipulate the given data so it shows the data that I requested instead of non applicable data. I will use joins to merge the 2 tables together and I u